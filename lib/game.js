...
let riverObstacles = [
      new Log(-10, 40, 70, 100),
      new Log(-370, 40, 70, 100),
      new Log(-200, 90, 70, 100),
      new Log(-300, 90, 70, 100),
      new Log(-650, 90, 70, 100),
      new Log(-400, 140, 70, 100),
      new Log(-100, 140, 70, 100),
      new Log(-10, 190, 70, 100),
      new Log(-400, 190, 70, 100),
      new Log(-200, 290, 70, 100),
      new Log(-10, 230, 70, 100)]

 let roadObstaclesCars = [
        new Car(10, 605, 35, 45),
        new Car(400, 605, 35, 45),
        new Car(250, 605, 35, 45),    
        new Car(10, 555, 35, 45),
        new Car(280, 555, 35, 45),
        new Car(-300, 555, 35, 45),    
        new Car(400, 505, 35, 45),
        new Car(800, 505, 35, 45),
        new Car(60, 505, 35, 45)] 
...
class Game {
    ...
    drawCharacters(c) {
      ...
      roadObstaclesCars.forEach(function (drawCar) {
        console.log(drawCar)
          this.drawCar(c);
    })
    }
    ...
    roadCollision(c) {
      if (this.frog.x < this.car.x + this.car.width 
        ...
        && this.frog.y < this.truck.y  + (this.truck.height - 100) 
        ...
        && this.frog.y < this.truck2.y + (this.truck2.height - 100) 
        ...
        && this.frog.y < this.truck3.y + (this.truck3.height - 100)
        ...
        && this.frog.y < this.truck4.y + (this.truck4.height - 100)
